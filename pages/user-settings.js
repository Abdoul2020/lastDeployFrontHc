...
function UserSettings() {
  ...
  const passwordChangeError = useSelector(
    (state) => state.userSlice.passwordChangeError
  );
  const passwordSuccess = useSelector(
    (state) => state.userSlice.passwordSuccess
  );

  const emailChangeSuccess = useSelector(
    (state) => state.userSlice.EmailChangeSuccess
  );
  const emailAlreadyExist = useSelector(
    (state) => state.userSlice.EmailExistAlready
  );
  ...
  useEffect(() => {
    emailChangeSuccess === true &&
      setemailAfterChange(newEmail.newEmailTochange);
  ...
  const [shareValueCardId, setshareValueCardId]=useState("")
  ...
  useEffect(() => {
    ...
    if(user && user.secretKod){

      setshareValueCardId(user.secretKod)
  ...
  const [cardAlPopup, setcardAlPopup]= useState(false)
    ...
    try {
      ...
      if(shareValueCardId !== ""){
        ...
        navigator.share({
          ...
          url: `https://panel.hibritcard.com/id/${shareValueCardId}`
  ...
  //         <Button onClick={onAccept}> Tamam </Button>
  //       </DialogActions>
  //     );
  //   };

  console.log("dogumTAR",userValues && userValues.birthDate)
...
<div onClick={() => { setcardAlPopup(false) }} className='close-button'>
...
Kartınız olmadığı için, Paylaşım yapamıyorsuunuz.
...
<a href="https://www.hibritcard.com/buy" target="_blank" style={{
  textDecoration:"none"
}}>

<div className='popup-button' onClick={() =>{ setcardAlPopup(false)}}>

<button className='profile-save-buttonn'>Kart Satın Al</button>
      ...
      {deletePopup ? (
        <div className="popup-global">
          ...
          <div className="popup">
            ...
            <div className="header-text">Hesabı Sil</div>
            <div className="description-text">
              Kullanıcı adını yazınız "
              {userValues && (
                <span style={{ color: "red" }}>
                  {userValues.userHandleName}
                </span>
              )}
              "
            </div>
            <div className="popup-input ">
              <div className="content-input">
                <input
                  value={deleteTagController.value}
                  onChange={(e) =>
                    setDeleteTagController((v) => ({
                      ...v,
        ...
        <div className="main-container">
          <div className="header-global">
            <div className="header">
              ...
              <div className="header-menu-area"></div>
          ...
          <div className="main-card-global">
            ...
            >
              <div className="main-card-header">Hesap</div>

              <div className="content-in content-input-padding">
                <div className="content-input">
                  <input
                    value={userValues && userValues.userHandleName}
                    onChange={(e) =>
                      setUserValues((v) => ({
                        ...v,
                        userHandleName: e.target.value.replace(
                          /[^a-z0-9]/gi,
                          ""
                        ),
                      }))
                    ...
                    type="text"
                    placeholder="Hesap Kullanıcı Adı"
                  />
                </div>
                <div className="content-input-row">
                  <input
                    value={userValues && userValues.publicName}
                    onChange={(e) =>
                      setUserValues((v) => ({
                        ...v,
                  ...
                  <input
                    value={userValues && userValues.publicSurname}
                    onChange={(e) =>
                      setUserValues((v) => ({
                        ...v,
                ...
                <div className="content-input">
                  <input
                    ...
                    onChange={(e) =>
                      setUserValues((v) => ({ ...v, eMail: e.target.value }))
                    }
                    type="button"
                    placeholder="E-Posta"
                    onClick={(e) => {
                          ...
                          <div>
                            <TextField
                              ...
                              onChange={(e) =>
                                setnewEmail((ne) => ({
                                  ...ne,
                                  newEmailTochange: e.target.value,
                                }))
                              }
                              type="email"
                              fullWidth
          ...
          <Button onClick={handleClose}>Kaydet</Button>
                  ...
                  <PhoneInput
                    ...
                    onChange={(e) =>
                      setUserValues((v) => ({ ...v, phoneNumber: e }))
                    }
                    placeholder="Telefon numarası"
                  />

                  <select
                    value={userValues && userValues.gender}
                    onChange={(e) =>
                      setUserValues((v) => ({ ...v, gender: e.target.value }))
                    }
                  >
              ...
              <div className="profile-save-button-global">
                <button
                  onClick={() => dispatch(userUpdateAsync(userValues))}
                  className="profile-save-button"
                >
                  Güncelle
                </button>
          ...
          <div className="main-card-global">
            <div className="main-card ">
              <div className="main-card-header">Güvenlik</div>
              <div className="content-in content-input-padding">
                <div className="content-input">
                  <div className="success-text">
                    {passwordSuccess &&
                      "Şifre başarılı bir şekilde güncellendi."}
                  </div>
                  <input
                    value={passwordChange.oldpassword}
                    onChange={(e) =>
                      setPasswordChange((pv) => ({
                        ...pv,
                  ...
                  <div className="error-text">
                    {passwordChangeError &&
                      passwordChangeError.passwordNotMatch &&
                      "Şifreler Eşleşmiyor."}
                  </div>
                  <div className="error-text">
                    {passwordChangeError &&
                      passwordChangeError.minCountCharacter &&
                      "Yeni olşturduğunuz şifre minimum 6 karakterden oluşmalı."}
                  </div>
                </div>
              </div>
          ...
          >
            <div className="account-buttons">
              ...
              <div
                onClick={() => exit()}
                className="global-button account-exit-button"
              >
                Çıkış yap
              </div>
            </div>
          ...
          <div className="content-input">
            <div className="content-min-link">
              <div
                ...
                className="global-button account-delete-buttonn"
              >
                <span className="hesap_Bottom">Hesabı sil</span>
              </div>
            </div>
          </div>
        </div>
