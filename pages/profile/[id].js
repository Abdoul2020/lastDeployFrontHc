...
const [hideLogowe, sethideLogowe]= useState(true)
  useEffect(() => {
    ...
    // if(userOnlyForm !== null && userOnlyForm && userOnlyForm !== undefined && userOnlyForm !==""){
    //   console.log("huggty",hideLogowe )
  ...
  const selectedProfilData =
    profile != "" && profile.find((s) => s.profileId == id);
  ...
  const lastname = selectedProfilData && selectedProfilData.publicName
const firstname = selectedProfilData && selectedProfilData.publicsurname
const additional = ''
const prefix = ''
const suffix = ''
  ...
  previewAllPanelListSort.map((v, i) => {
    myVCard
      ...
      .addAddress(
        ...
        v.streetAdress && v.streetAdress,
        "",
        "",
        v.profileCity && v.profileCity ,
        "",
        "",
        v.profileCountry && v.profileCountry==="Turkey" ? "TÜRKİYE": v.profileCountry,
    ...
    if (v.type === "conatctAddForm" && v.panelPhoneNumbers) {
      ...
      v.panelPhoneNumbers.map((w, a) => {
        ...
        myVCard.addPhoneNumber(w.phoneNumber, "PREF;WORK");

      });
    }  if (v.type === "conatctAddForm" && v.panelEmailPostas) {
      v.panelEmailPostas.map((w, a) => {
        myVCard.addEmail(w.emailPosta);
      });
    }
  });
  ...
  useEffect(() => {
    ...
    console.log("seeeAllInside",previewAllPanelListSort )
    setDropdownList([]);
    ...
    console.log("OtineeE:.",previewAllPanelListSort )
  ...
  const downloadTxtFile2 = (v) => {
    ...
    v.panelPhoneNumbers &&
      v.panelPhoneNumbers.map((w, i) => {
        myVCard2.addPhoneNumber(w.phoneNumber, "PREF;PERSONAL");
      });

    v.panelEmailPostas &&
      v.panelEmailPostas.map((w, i) => {
        myVCard2.addEmail(w.emailPosta);
      });
  ...
  useEffect(() => {
    if (localStorage.getItem("GZIToken")) {
      ...
      dispatch(getOnlyuserTop({
        eMail:selectedProfilData &&  selectedProfilData.eMail
      } ))
    } else {
      router.push("/login");
    }
  ...
  const backgroundColor =
    selectedProfilData.profileTheme === "light" ? "#FFF" : "#333";

  const saveButtonBackGround =
    selectedProfilData.profileTheme === "light" ? "black" : "#8b8dff";
  const saveColor =
    selectedProfilData.profileTheme === "light" ? "#FFFF" : "#FFF";
  ...
  const GenerateQRCode = () => {
    QRCode.toDataURL(
      ...
      (err, url) => {
        if (err) {
          return console.log("ErrorSignal", err);
        }
        setqrcode(url);
      }
    );
  ...
  console.log("bakalu",socialMediaListSort )
    ...
    v.statuMode === true && (
       ...
       items2.push(
        ...
        <div key={v.socialMediaUrlId} className="profile-social-item">
          <a
            href={
              v.socialtype === "whatsapp"
                ? "https://wa.me/" + v.socialUrlLink
                : v.socialtype === "web"
                ? "http://" + v.socialUrlLink
                : v.socialtype === "linkedin"
                ? "https://www.linkedin.com/in/" + v.socialUrlLink
                : "https://" + v.socialtype + ".com/" + v.socialUrlLink
            }
            target="_blank"
          >
      ...
      >
        ...
        <div className="profile-area">
          <div className="profile-image">
            ...
            <div className="share-icon" onClick={shareAllData}>
              {selectedProfilData &&
                        ...
                        <div>
                          ...
                          >
                            ...
                            <path
                              fill-rule="evenodd"
                              clip-rule="evenodd"
                              d="M6.21913 8.3753C6.56414 7.94404 7.19343 7.87412 7.6247 8.21913L12 11.7194L16.3753 8.21913C16.8066 7.87412 17.4359 7.94404 17.7809 8.3753C18.1259 8.80657 18.056 9.43586 17.6247 9.78087L12 14.2806L6.37531 9.78087C5.94404 9.43586 5.87412 8.80657 6.21913 8.3753Z"
                              fill="black"
                            />
                          </svg>
                        </div>
        ...
        Open dialog
          ...
          >
            ...
            <DialogActions>
              ...
              >
                <Button autoFocus>QR'İ İNDİR</Button>
              </a>
            </DialogActions>
          </BootstrapDialog>
        </div>
        ...
        <div className="profile-content">
          ...
          <div className="profile-dropdown">
            ...
            <div
              className={
                "dropdown-content " +
                (dropdownList[0] && dropdownList[0].open == true
                  ? "dopen"
                  : "dclose")
              }
            >
                      ...
                      <div className="dropdown-left-icon">
                          ...
                          selectedProfilData.profileTheme == "light" ? (
                            ...
                            >
                              <path
                                fill-rule="evenodd"
                                clip-rule="evenodd"
                                d="M12 10C12.5523 10 13 10.4477 13 11L13 14.5858L14.2929 13.2929C14.6834 12.9024 15.3166 12.9024 15.7071 13.2929C16.0976 13.6834 16.0976 14.3166 15.7071 14.7071L12.7071 17.7071C12.3166 18.0976 11.6834 18.0976 11.2929 17.7071L8.29289 14.7071C7.90237 14.3166 7.90237 13.6834 8.29289 13.2929C8.68342 12.9024 9.31658 12.9024 9.70711 13.2929L11 14.5858L11 11C11 10.4477 11.4477 10 12 10Z"
                                fill="#808080"
                              />
                              <path
                                fill-rule="evenodd"
                        ...
                        {v.type == "documentForm" &&
                          ...
                          selectedProfilData.profileTheme == "light" ? (
                            ...
                            <path d="M18.5405 20.5C17.534 17.8686 14.9853 16 12.0001 16C9.01489 16 6.46614 17.8686 5.45972 20.5" stroke="#808080" stroke-width="2"/>
                            </svg>
                            
                          ) : (
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<rect x="3" y="3" width="18" height="18" rx="4" stroke="#333333" stroke-width="2"/>
<circle cx="12" cy="10" r="3" stroke="#333333" stroke-width="2"/>
<path d="M18.5405 20.5C17.534 17.8686 14.9853 16 12.0001 16C9.01489 16 6.46614 17.8686 5.45972 20.5" stroke="#333333" stroke-width="2"/>
</svg>
                      ...
                      >
                        <div className="dropdown-text">
                          ...
                          >
                            {v.type == "conatctAddForm" && v.panelTitle === ""
                              ? "İletişim Bilgileri"
                              : v.type === "uploadFileDocument" &&
                                v.panelTitle === ""
                              ? "Belge"
                              : v.type === "urlLinkPanel" && v.panelTitle === ""
                              ? "Linkler"
                              : v.type === "bankform" && v.panelTitle === ""
                              ? "Banka Hesapları"
                              : v.type === "documentForm" && v.panelTitle === ""
                              ? "Müşteri Formu"
                              : v.type === "faturaData" && v.panelTitle === ""
                              ? "Fatura Bilgisi"
                              : v.panelTitle}
                          </div>
                        </div>
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              ...
                              {v.type === "urlLinkPanel" && "Linkler"}

                              {v.type === "bankform" && "Banka Hesapları"}

                              {v.type === "documentForm" && "Müşteri Formu"}
                      ...
                      {v.type == "conatctAddForm" && (
                        <>
                          ...
                          <div className="content-in">
                                  ...
                                  <>
                                    {w.phoneNumber ? (
                                      <div className="in-item">
                                        <div className="image">
                                          {selectedProfilData &&
                                          selectedProfilData.profileTheme ==
                                            "light" ? (
                                            <img src="/icons/Phone-AEAEB4.svg" />
                                          ) : (
                                            <img src="/icons/Phone-666666.svg" />
                            ...
                            {selectedProfilData && v.panelPhoneNumbers.length > 0 && v.panelPhoneNumbers[0].phoneNumber ? (
                              <a
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M7 2C4.23858 2 2 4.23858 2 7V17C2 19.7614 4.23858 22 7 22H17C19.7614 22 22 19.7614 22 17V7C22 4.23858 19.7614 2 17 2H7ZM11.2929 7.29289C11.6834 6.90237 12.3166 6.90237 12.7071 7.29289L16.7071 11.2929C16.8946 11.4804 17 11.7348 17 12C17 12.2652 16.8946 12.5196 16.7071 12.7071L12.7071 16.7071C12.3166 17.0976 11.6834 17.0976 11.2929 16.7071C10.9024 16.3166 10.9024 15.6834 11.2929 15.2929L13.5858 13H8C7.44772 13 7 12.5523 7 12C7 11.4477 7.44772 11 8 11H13.5858L11.2929 8.70711C10.9024 8.31658 10.9024 7.68342 11.2929 7.29289Z" fill="#333333"/>
                            ...
                            {v.profileUrlPanel != undefined &&
                              v.profileUrlPanel.map((w, a) => {
                                return (
                                  <>
                                    {w.socialUrlLink && (
                                      <div className="in-item">
                                        <div className="image">
                                          ...
                                          selectedProfilData.profileTheme ===
                                            ...
                                            w.socialtype === "whatsapp" ? (
                                              ...
                                              <div>
                                                <i
                                                  class="fa-brands fa-kikmessenger"
                                                  style={{ color: "#aeaeb4" }}
                                                ></i>
                                              </div>
                                            ) : w.socialtype === "twitch" ? (
      ...
      <span> {v.panelUrlLink}</span>
                      ...
                      {v.type == "uploadFileDocument" && (
                        <>
                          <div className="content-in ">
                            {v.belgeDocumentUploads !== undefined &&
                              v.belgeDocumentUploads.map((q, p) => {
                                return (
                                  <>
                                    {q.belgeDocument &&
                                      q.belgeDocument != "" && (
                                  ...
                                  selectedProfilData.profileTheme == "light" ? (
                                    ...
                                    >
                                      <path
                                        fill-rule="evenodd"
                                        clip-rule="evenodd"
                                        d="M13.9036 4.85668C12.7971 3.94825 11.2029 3.94825 10.0964 4.85668L4.73093 9.26166C4.2682 9.64155 4 10.2088 4 10.8074V18C4 19.1046 4.89543 20 6 20H18C19.1046 20 20 19.1046 20 18V10.8074C20 10.2088 19.7318 9.64155 19.2691 9.26166L13.9036 4.85668ZM8.82732 3.31089C10.6715 1.79685 13.3285 1.79685 15.1727 3.31089L20.5381 7.71587C21.4636 8.47565 22 9.61006 22 10.8074V18C22 20.2091 20.2091 22 18 22H6C3.79086 22 2 20.2091 2 18V10.8074C2 9.61006 2.53641 8.47565 3.46186 7.71587L8.82732 3.31089Z"
                                        fill="black"
                                      />
                                      <path
                                        fill-rule="evenodd"
                                  ...
                                  selectedProfilData.profileTheme == "light" ? (
                                    ...
                                    >
                                      ...
                                      <path
                                        fill-rule="evenodd"
                                        clip-rule="evenodd"
                                        d="M6.21913 8.37528C6.56414 7.94402 7.19343 7.8741 7.6247 8.21911L12 11.7194L16.3753 8.21911C16.8066 7.8741 17.4359 7.94402 17.7809 8.37528C18.1259 8.80654 18.056 9.43584 17.6247 9.78084L12 14.2806L6.37531 9.78084C5.94404 9.43584 5.87412 8.80654 6.21913 8.37528Z"
                                        fill="#808080"
                                      />
                                    </svg>
                                  ) : (
