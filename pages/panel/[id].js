...
import {
  ...
  getAllSocialMediaAsync,
  newSocialUrlAddAsync,
  updateSocialMediaUrlAsync,
} from "../../stores/socialSlice";
    ...
    render={({
      ...
      <React.Fragment>
        <input
          {...rest}
          onChange={(e) => {
            onChangeTwo(e, indexTbwo);
            onChange(e);
            
          }}
          value={bankIbanFormat}
          placeholder="IBAN"
          name="bankIban"
        />{" "}
        {Boolean(iban) && (
...
function Panel() {
  ...
  const onlyFileUploadStatus = useSelector(
    (state) => state.userSlice.onlyFileUploadStatus
  );
  ...
  const { cities, city, setCity, districts, district, setDistrict } =
    useTurkeyCities(); //Türkiye Cities
  ...
  // get all the panel again from here
  ...
  function updateAllsociall() {
    ...
    console.log("OkGun", socialList)
    console.log("OkGunuuuj", panelProfileUrlSev)


    // panelProfileUrlSev.map((v, i) => {

    //   const data = {
    //     socialId: v.socialMediaLinkMatch,
    //     value: {
  ...
  useEffect(() => {
    if (updateStatueModeFatura.faturaDataId != undefined) {
      dispatch(updatFaturaStatusModeAsync(updateStatueModeFatura));
    }
  ...
  function getAllPanelFromHere() {
    ...
    panelListSort.map((v, i) => {
      if (
        v.OrderId === i ||
        (v.id === i && v.type === "bankform" && v.BankDataId === undefined)
      ) {
        ...
        v.OrderId === i ||
        (v.id === i && v.type === "faturaData" && v.faturaDataId === undefined)
      ) {
        dispatch(
          getProfilePanelAsync(localStorage.getItem("selectedProfileId"))
        );
    ...
    bankFiledAdd.map((v, i) => {
      for (let index = 0; index <= bankFiledAdd.length; index++) {
        ...
        dispatch(
          ...
          console.log("DtataVerii")

          setPanels((v) =>
          panelListSort.map((s, i) =>
            s.OrderId === i && s.isOpen === true
                ? { ...s, bankDataAll: bankFiledAdd
                 }
                : { ...s, publicName: "else", publicsurname: "else" }
          )
        );
  ...
  const [profileUrlofSocialMediaId, setprofileUrlofSocialMediaId] =
    useState("");
  ...
  // just update one by one from here
  function updateUrolOneByone(){
    ...
    panelProfileUrlSev.map((v, i) => {
      ...
      dispatch(
        updateProfileUrlDataArrayInfoAsync({
          ...
          socialMediaLinkMatch: v.socialMediaLinkMatch,
        ...
        //   updateSocialMediaFromUrlpanel(
        //     v.socialMediaLinkMatch,
        //     v.socialUrlLink
        //   ).then(()=>{
            

        //     dispatch(updateSocialMediaUrlAsync({
        //       socialId: v.socialMediaLinkMatch,
        //   socialtype: v.socialtype,
        //   socialUrlLink: v.socialUrlLink,
        //   statuMode: v.statuMode,
        ...
        setoldUrlPanelData(panelProfileUrlSev)
  ...
  function updateprofileUrlDataArray() {
    ...
    panelProfileUrlSev.map((v, i) => {
      ...
      dispatch(
        updateProfileUrlDataArrayInfoAsync({
         ...
         profileId: selectedProfileId,
          ...
          socialMediaLinkMatch: v.socialMediaLinkMatch,
            ...
            oldSocialorder: oldUrlPanelData.length > 0 && oldUrlPanelData[i] ? oldUrlPanelData[i].socialOrder: "",
            oldSocialHead: oldUrlPanelData.length > 0 && oldUrlPanelData[i] ? oldUrlPanelData[i].socialUrlHead: "",
            oldSocialUrlLink: oldUrlPanelData.length > 0 && oldUrlPanelData[i] ? oldUrlPanelData[i].socialUrlLink: "",
            oldSocialType : oldUrlPanelData.length > 0 && oldUrlPanelData[i] ? oldUrlPanelData[i].socialtype: "",
            oldStatueMode : oldUrlPanelData.length > 0 && oldUrlPanelData[i] ? oldUrlPanelData[i].statuMode: "",
            oldplaceHolder : oldUrlPanelData.length > 0 && oldUrlPanelData[i] ? oldUrlPanelData[i].placeholder: "",
            oldSocialMediaMatch : oldUrlPanelData.length > 0 && oldUrlPanelData[i] ? oldUrlPanelData[i].socialMediaLinkMatch: ""
        ...
        panelListSort.map((s, i) =>
          s.OrderId === i && s.isOpen === true
              ? { ...s, profileUrlPanel: panelProfileUrlSev
               }
              : { ...s, profileUrlPanel: panelProfileUrlSev }
        )
      );
  ...
  const [oldPanelcontactData, setoldPanelcontactData]= useState([]);
  const [olPanelEmail, setolPanelEmail]= useState([]);
  const [oldUrlPanelData, setoldUrlPanelData]= useState([]);


// update only contact form from here when click yeni ekle
  function updateContactOnlyfrom(){

    console.log("hummLou",radioButtonIndexPhone,"valuuuuer::", radionButtonValuePhone)
      ...
      //for (let index = 0; index <= telefonInputServ.length; index++) {
        ...
        dispatch(
          updateOnlyPhoneInputContactInfoAsync({
            ...
            newEnterDefaultPhone:
              radioButtonIndexPhone == 0 && radioButtonIndexPhone == i
                ? true
                : radioButtonIndexPhone == i
          ...
          setoldPanelcontactData(telefonInputServ)
        })
      //}
 ...
 function updateEmailOnlyFrom(){
    ...
    for (let index = 0; index <= emailInputServ.length; index++) {
      dispatch(
        updateOnlyEmailInputContactInfoAsync({
          ...
          newEmailDefault:
            radioButtonIndexEmail == 0 && radioButtonIndexEmail == i
              ? true
              : radioButtonIndexEmail == i
        ...
        setolPanelEmail(emailInputServ)
      })
    }
  });
  ...
  function updateContactData(id, panelPhoneNumbers) {
    ...
    console.log("OlfdataHere::",oldPanelcontactData)

    console.log("pakonel",panelPhoneNumbers);
    dispatch(updateContactInfoAsync(bankDataDetails2))
      .then(() => {

        console.log("İnputBABKK",telefonInputServ)

        console.log("Indexxc",radioButtonIndexPhone, "valuuert",radionButtonValuePhone )

        telefonInputServ.map((v, i, x) => {

          console.log("whathere::", x)
          //for (let index = 0; index <= telefonInputServ.length; index++) {
            dispatch(
              updateOnlyPhoneInputContactInfoAsync({
                conatctDataId: contactDataId,
              ...
              updateOnlyEmailInputContactInfoAsync({
                ...
                newEmailDefault:
                  radioButtonIndexEmail == 0 && radioButtonIndexEmail == i
                    ...
                    : false,
                arrayLentghToChange: i,
                existEmail:olPanelEmail.length > 0 && olPanelEmail[i] ? olPanelEmail[i].emailPosta: "",
                existDefaultEamil:olPanelEmail.length >0 && olPanelEmail[i] ? olPanelEmail[i].defaultEmaill: ""
      ...
      panelListSort.map((s, i) =>
        s.OrderId === i && s.isOpen === true
            ? { ...s, publicName: publicName, publicsurname: publicsurname,
              publicOrganization: publicOrganization,profilePosition:profilePosition,
              panelPhoneNumbers: telefonInputServ, panelEmailPostas: emailInputServ,
              streetAdress: streetAdress, profileCountry: profileCountry,profileCity:profileCity,
              profileNot:profileNot
             }
            : { ...s, publicName: "else", publicsurname: "else" }
      )
  ...
  function deletePhoneArrayInContact(
    e,
    existPhoneNumberrr,
    existDefaultPhoneee,
    index
  ...
  function deleteEmailArrayInContact(
    e,
    existPhoneNumberrr,
    existDefaultPhoneee,
    index
  ...
  //delete File Upload Array
  function deleteBankArrayOnlyOne(
    e,
    exisBankIban,
    existAccountOwner,
    existbankNumber,
  ...
  function deleteProfileUrlElementArrayOnlyOne(
    e,
    exiseMail,
    existgeneralUserId,
    existplaceholder,
  ...
  function updateFaturaDataInfo(event) {
    ...
    dispatch(
      ...
      panelListSort.map((s, i) =>
        s.OrderId === i && s.isOpen === true
            ? { ...s, companyStatus: companyStatus, taxNumber: taxNumber,
              taxAdministration: taxAdministration,officeEmail:officeEmail,
              panelPhoneNumbers: telefonInputServ, panelEmailPostas: emailInputServ,
              officePhoneNumber: officePhoneNumber, location: location
             }
            : { ...s, companyStatus: companyStatus, taxNumber: taxNumber,
              taxAdministration: taxAdministration,officeEmail:officeEmail,
              panelPhoneNumbers: telefonInputServ, panelEmailPostas: emailInputServ,
  ...
  function updateDoumentData(event) {
    event.preventDefault();
    dispatch(updateDocumentInfoAsync(documentDataDetails3)).then(()=>{
    ...
    panelListSort.map((s, i) =>
      s.OrderId === i && s.isOpen === true
          ? { ...s, publicDropNot: publicDropNot, publicstreetAdress: publicstreetAdress,
            emailToSend: emailToSend, statusEmail:statusEmail, statusTelefon:statusTelefon,
            statusMessage:statusMessage
           }
          : { ...s,  ppublicDropNot: publicDropNot, publicstreetAdress: publicstreetAdress,
            emailToSend: emailToSend, statusEmail:statusEmail, statusTelefon:statusTelefon,
            statusMessage:statusMessage}
    )
  );
  ...
  useEffect(() => {
    ...
    console.log("pAAA::", panelListSort)
  ...
  async function PanelOpen(
    ...
    setoldUrlPanelData(profileUrlPanel ? profileUrlPanel : []);
  ...
  async function RemovePanelRemoveFatura(arr) {
    ...
    //let secondItemTodelete=newArray.map((s)=>s.type == "conatctAddForm")
    const index = newArray.findIndex((element) => element.type == "faturaData");
  ...
  function handleChangeFileToUpload(e) {
    dispatch(
      ...
      panelListSort.map((v, i) => {
        if (
          v.type === "uploadFileDocument" &&
          v.belgeDocumentUploads.length > 1
        ) {
          // setuploadFileField(v.belgeDocumentUploads);
...
const [ibanChangesi,setibanChangesi]= useState("")

  useEffect(() => {

    console.log("banokAddFileAll", bankFiledAdd);
  ...
  function onChange({ value, iban }) {
    ...
    console.log("Whatisthat::", value, "noHere", iban)
  ...
  function addUrlPanelInputHandle(
    urlLinkNamee,
    placeholder,
    socialUrlLink,
    socialtype
  ) {
    setpanelProfileUrlSev([
      ...panelProfileUrlSev,
      {
  ...
  const [checkedKontrol, setcheckedKontrol]=useState(false)

  useEffect(() => {
    //setcheckedKontrol(true)
  }, [checkedKontrol])

  const [checkedRadioBut, setcheckedRadioBut]= useState(false);
  ...
  function handleDefaultPhoneFrom(e, index) {
    ...
    console.log("indexx:",index,"heryttu", e)
    
    const list = [...telefonInputServ];


    console.log("uyudft", list );
  ...
  function getRadioButtonIndexPhone( index) {

    //setradioButtonIndexPhone(index);
    console.log("indexxk", index, "radioButton", radioButtonIndexPhone)
  ...
  function getRadioButtonIndexEmail(index) {
  ...
  const [socialMediaListSort, setSocialMediaListSort] = useState(
    socialMediaList != undefined
      ? [...socialMediaList].sort((a, b) => a.socialOrder - b.socialOrder)
      : []
  );

  useEffect(() => {
    setSocialMediaListSort(
      socialMediaList != undefined
        ? [...socialMediaList].sort((a, b) => a.socialOrder - b.socialOrder)
        : []
    );
    ...
    setAllSocialMedia([
      {
        ...
        socialMediaAdded: socialMediaListSort.find((v) =>
          v.socialtype == "website" ? true : false
        ),
        urlLink: "http://",
      ...
      },
      {
        ...
        socialMediaAdded: socialMediaListSort.find((v) =>
          v.socialtype == "whatsapp" ? true : false
        ),
        urlLink: "http://wa.me/+",
        socialtype: "whatsapp",
        socialUrlLink: "",
...

      {
        ...
        socialMediaAdded: socialMediaListSort.find((v) =>
          v.socialtype == "instagram" ? true : false
        )
          ? true
          : false,
...

      {
        ...
        socialMediaAdded: socialMediaListSort.find((v) =>
          v.socialtype == "facebook" ? true : false
        )
          ? true
          : false,
...

      {
        ...
        socialMediaAdded: socialMediaListSort.find((v) =>
          v.socialtype == "linkedin" ? true : false
        )
          ? true
          : false,
...

      {
        ...
        socialMediaAdded: socialMediaListSort.find((v) =>
          v.socialtype == "youtube" ? true : false
        )
          ? true
          : false,
...

      {
        ...
        socialMediaAdded: socialMediaListSort.find((v) =>
          v.socialtype == "telegram" ? true : false
        )
          ? true
          : false,
     ...
     
      {
        ...
        socialMediaAdded: socialMediaListSort.find((v) =>
          v.socialtype == "discord" ? true : false
        )
          ? true
          : false,
      ...
      },
      {
        ...
        socialMediaAdded: socialMediaListSort.find((v) =>
          v.socialtype == "dribbble" ? true : false
        )
          ? true
          : false,
      ...
      },
      {
        ...
        socialMediaAdded: socialMediaListSort.find((v) =>
          v.socialtype == "github" ? true : false
        )
          ? true
          : false,
      ...
      },
      {
        ...
        socialMediaAdded: socialMediaListSort.find((v) =>
          v.socialtype == "hangouts" ? true : false
        )
          ? true
          : false,
      ...
      },
      {
        ...
        socialMediaAdded: socialMediaListSort.find((v) =>
          v.socialtype == "kikmessenger" ? true : false
        )
          ? true
          : false,
      ...
      },
      {
        ...
        socialMediaAdded: socialMediaListSort.find((v) =>
          v.socialtype == "twitch" ? true : false
        )
          ? true
          : false,
      ...
      },
      {
        ...
        socialMediaAdded: socialMediaListSort.find((v) =>
          v.socialtype == "medium" ? true : false
        )
          ? true
          : false,
      ...
      },
      {
        ...
        socialMediaAdded: socialMediaListSort.find((v) =>
          v.socialtype == "nimotv" ? true : false
        )
          ? true
          : false,
      ...
      },
      {
        ...
        socialMediaAdded: socialMediaListSort.find((v) =>
          v.socialtype == "periscope" ? true : false
        )
          ? true
          : false,
      ...
      },
      {
        ...
        socialMediaAdded: socialMediaListSort.find((v) =>
          v.socialtype == "dailymotion" ? true : false
        )
          ? true
          : false,
      ...
      },
      {
        ...
        socialMediaAdded: socialMediaListSort.find((v) =>
          v.socialtype == "wechat" ? true : false
        )
          ? true
          : false,
      ...
      },
      {
        ...
        socialMediaAdded: socialMediaListSort.find((v) =>
          v.socialtype == "qqtile" ? true : false
        )
          ? true
          : false,
      ...
      },
      {
        ...
        socialMediaAdded: socialMediaListSort.find((v) =>
          v.socialtype == "sineweibo" ? true : false
        )
          ? true
          : false,
      ...
      },
      {
        ...
        socialMediaAdded: socialMediaListSort.find((v) =>
          v.socialtype == "pinterest" ? true : false
        )
          ? true
          : false,
      ...
      },
      {
        ...
        socialMediaAdded: socialMediaListSort.find((v) =>
          v.socialtype == "reddit" ? true : false
        )
          ? true
          : false,
      ...
      },
      {
        ...
        socialMediaAdded: socialMediaListSort.find((v) =>
          v.socialtype == "behance" ? true : false
        )
          ? true
          : false,
      ...
      },
      {
        ...
        socialMediaAdded: socialMediaListSort.find((v) =>
          v.socialtype == "signal" ? true : false
        )
          ? true
          : false,
      ...
      },
      {
        ...
        socialMediaAdded: socialMediaListSort.find((v) =>
          v.socialtype == "snapchat" ? true : false
        )
          ? true
          : false,
              ...
              countFaturaData != 0 ? (
                <div
                  ...
                  onClick={(e) => {
                    ...
                    countFaturaData != 0
                      ? postFaturaFromData(e, panelListSort)
                      : "";
                  }}
                >
                  <svg
      ...
      Ekle
                  ...
                  <div className="type-add" style={{ display: "flex" }}>
                    ...
                    <div
                      ...
                      id="increase"
                      onClick={(e) => {
                        NewPanelFtauraEkle(e);
                        IncreaseAddFaturaDataPanel(e);
                        ekleDolduFaturaYazi(e);
                      }}
        ...
        {socialAdd ? (
          <div className="popup-global">
            ...
            <div className="popup">
              ...
              <div className="header-text">Yeni hesap ekle</div>

              <div className="description-text">
                Dilediğin sosyal medya hesaplarını buradan profiline
                ekleyebilirsin.
              </div>
              ...
              <div className="filter-input">
                <input
                  type="text"
                  placeholder="Sosyal medya arayın"
                  value={socialMediaFilterText}
                  onChange={(e) => {
                    setSocialMediaFilterText(e.target.value);
                    e.target.value != ""
                      ? setAllSocialMediaFilter(
                          [...allSocialMedia].filter((s) =>
                            s.socialMeidaName
                              .toLowerCase()
              ...
              <div className="social-types">
                {allSocialMediaFilter.map((v, i) => {
                  return (
                    <div
                      key={i}
                      className="social-type-item"
                      onClick={(e) => {
                        addUrlLinkOfSocial(e, v);
                        seturlLinkName(v.urlLink);
                        console.log("amabirWao")
                        // updateUrolOneByone()
                      }}
                    >
                      <div
                          ...
                          <button className="item-content">
                                      ...
                                      <div>
                                        ...
                                        >
                                          ...
                                          <path
                                            fill-rule="evenodd"
                                            clip-rule="evenodd"
                                            d="M12.1584 16C8.87071 16 6.0954 16.7732 4.56645 17.8241L3.43359 16.1759C5.41246 14.8158 8.63551 14 12.1584 14C15.4844 14 18.5304 14.7265 20.521 15.9415L19.4791 17.6486C17.8986 16.684 15.2489 16 12.1584 16Z"
                                            fill="#ABCAFF"
                                          />
                                          <path
                                            fill-rule="evenodd"
                                            clip-rule="evenodd"
                                            d="M12.0642 9.99998C8.57877 9.99998 5.38856 9.18344 3.4292 7.821L4.571 6.17896C6.07894 7.22751 8.81778 7.99998 12.0642 7.99998C15.2287 7.99998 17.9166 7.26561 19.4486 6.2527L20.5516 7.92102C18.5849 9.22139 15.4683 9.99998 12.0642 9.99998Z"
                                            fill="#ABCAFF"
                                          />
                                        </svg>
                                      </div>
                                      ...
                                      <div>
                                        ...
                                        >
                                          <path
                                            fill-rule="evenodd"
                                            clip-rule="evenodd"
                                            d="M3.33333 5C3.33333 3.15905 4.82571 1.66667 6.66666 1.66667H13.3333C15.1743 1.66667 16.6667 3.15905 16.6667 5V15C16.6667 16.8409 15.1743 18.3333 13.3333 18.3333H6.66666C4.82571 18.3333 3.33333 16.8409 3.33333 15V5ZM6.66666 3.33333C5.74619 3.33333 4.99999 4.07953 4.99999 5V15C4.99999 15.9205 5.74619 16.6667 6.66666 16.6667H13.3333C14.2538 16.6667 15 15.9205 15 15V5C15 4.07953 14.2538 3.33333 13.3333 3.33333H6.66666Z"
                                            fill="#8B8DFF"
                                          />
                                          <path
                                            fill-rule="evenodd"
                                            clip-rule="evenodd"
                                            d="M6.66666 1.66667H6.75925C7.79472 1.66667 8.66477 2.37487 8.91146 3.33333H11.0885C11.3352 2.37487 12.2053 1.66667 13.2407 1.66667H13.3333V3.33333H13.2407C12.9339 3.33333 12.6852 3.58206 12.6852 3.88889C12.6852 4.50254 12.1877 5 11.5741 5H8.42592C7.81227 5 7.3148 4.50254 7.3148 3.88889C7.3148 3.58206 7.06607 3.33333 6.75925 3.33333H6.66666V1.66667Z"
                                            fill="#8B8DFF"
                                          />
                                          <path
                                            fill-rule="evenodd"
                                            clip-rule="evenodd"
                                            d="M9.41075 7.74408C9.73619 7.41864 10.2638 7.41864 10.5893 7.74408L13.0893 10.2441C13.4147 10.5695 13.4147 11.0972 13.0893 11.4226C12.7638 11.748 12.2362 11.748 11.9107 11.4226L10.8333 10.3452L10.8333 13.3333C10.8333 13.7936 10.4602 14.1667 10 14.1667C9.53977 14.1667 9.16667 13.7936 9.16667 13.3333L9.16667 10.3452L8.08926 11.4226C7.76382 11.748 7.23619 11.748 6.91075 11.4226C6.58531 11.0972 6.58531 10.5695 6.91075 10.2441L9.41075 7.74408Z"
                                            fill="#8B8DFF"
                                          />
                                        </svg>
                                      </div>
                            ...
                            <div className="footer">
                              <div className="footer-left">
                                ...
                                <div className="text">
                                  {" "}
                                  {value.clickCountNumber}-(Tıklanma Sayısı){" "}
                                </div>{" "}
                              </div>{" "}
...
{/* )} */}
        ...
        {/* <FormControlLabel value="other" control={<Radio />}  /> */}
                                  ...
                                  {/* here will be add more for the contact */}

                                  {telefonInputServ.length ===
                                          0 && (
                                          <div
                                            style={{
                                              display: "flex",
                                      ...
                                      <div>
                                        ...
                                        >
                                          ...
                                          <div
                                            ...
                                            style={{ margin: "auto" }}
                                            onClick={(e) => {
                                              deleteEmailArrayInContact(
                                                e,
                                                singleEmailInput.emailPosta,
                                                singleEmailInput.defaultEmaill,
                                                index
                                              );
                                            }}
                                          >
                                        ...
                                        >
                                          ...
                                          >
                                            <svg
                                              ...
                                              xmlns="http://www.w3.org/2000/svg"
                                              onClick={(e) =>
                                                deleteBankArrayOnlyOne(
                                                  e,
                                                  singleBankField.bankIban,
                                                  singleBankField.accountOwner,
                                          ...
                                          <div className="two-input-area">
                                            ...
                                            <input
                                              ...
                                              onChange={(e) =>
                                                handleBankPanelListBankStation(
                                                  e,
                                                  index
                                                )
                                              }
                                    ...
                                    /> */}
                                          ...
                                          <div className="panel-input">
                                            <AccountNumberInput
                                              ...
                                              onChangetWO={
                                                handleBankPanelListBankAccountNumber
                                              }
                                              indexTwo={index}
                                              value={
                                                singleBankField.bankAccountNumber
                                              ...
                                              accountNumberFormat={
                                                ...
                                                bankAccountNum==="" ?  singleBankField.bankAccountNumber : bankFiledAdd.length -1 === index  ? bankAccountNum :  singleBankField.bankAccountNumber
                            ...
                            >
                              ...
                              <div className="panel-inner-content">
                                <div className="panel-inner-content-info">
                                  ...
                                  <div
                                    className="panel-input"
                                    onClick={handleChangeFileToUpload}
                                  >
                                    <button className="global-button content-buttons-item primary-button">
                                      {belgeDocumentId != undefined
                                        ? "Güncelle"
                                        : "Kaydet"}
                                    </button>
                          ...
                          <div>
                            ...
                            >
                              ...
                              <div className="panel-inner-content">
                                <div className="panel-inner-content-info">
                                  <div
                                    className="social-link-add-button-2"
                                    onClick={() => setSocialAdd(true)}
                                  >
                                    ...
                                    (singleUrl, index) => (
                                      ...
                                      >
                                        ...
                                        <TextField
                                          ...
                                          onChange={(e) =>
                                            handleProfileUrlToChange(e, index)
                                          }
                                          fullWidth
                                          autoFocus={
        ...
        index && ( */}
                                        ...
                                        <div
                                          ...
                                          onClick={(e) => {
                                            ...
                                            deleteProfileUrlElementArrayOnlyOne(
                                              e,
                                              singleUrl.eMail,
                                              singleUrl.generalUserId,
                                              singleUrl.placeholder,
                                              singleUrl.socialOrder,
                                              singleUrl.socialUrlHead,
                                              singleUrl.socialUrlLink,
                                              singleUrl.socialtype,
                                              singleUrl.statuMode,
                                              singleUrl.socialMediaLinkMatch,
                                              index
                                            );
                                          }}
                                        >
                                ...
                                <div className="panel-inner-content-info">
                                  ...
                                  <div className="panel-input">
                                    <PhoneInput
                                      ...
                                      type="tel"
                                      value={officePhoneNumber}
                                      onChange={(e) => {setofficePhoneNumber(e); console.log("PjoneHEE", officePhoneNumber)}}
                                  ...
                                  <div className="panel-input">
                                    ...
                                    {profileInputErrors &&
                                      profileInputErrors.emailFormatError2 && (
