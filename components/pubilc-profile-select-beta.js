...
function PublicProfileSelectBeta({
  selectedProfileData,
  allSocialSort,
  allPanelSort,
  parentUrl
...
v.panelEmailPostas.map((w,a)=>{
  ...
  const backgroundColor=selectedProfileData.profileTheme === "light" ? "#FFF" : "#333";

  const saveButtonBackGround=selectedProfileData.profileTheme === "light" ? "black"  : "#8b8dff" ;
  const saveColor =selectedProfileData.profileTheme === "light" ? "#FFFF" : "#FFF"
...
export default PublicProfileSelectBeta;
