...
function PublicProfilePage({
  ...
  const [getbase64Url,setgetbase64Url]=useState("")



  const getBase64ImageFrom=(url,callback)=>{
  ...
  const urlToSend= selectedProfileData && selectedProfileData.profileUrl
  //console.log("urlSimple",urlToSend )

  const bak="https://www.gravatar.com/avatar/d50c83cc0c6523b4d3f6085295c953e0"


  if(urlToSend !== undefined){
    
    getBase64ImageFrom(urlToSend, function(dataUrl) {

      
      var base64result = dataUrl.split(',')[1];
      //console.log('RESULTData:', base64result)
      setgetbase64Url(base64result)
    })
  ...
  .addName(
    ...
    selectedProfileData && selectedProfileData.publicName + " " + selectedProfileData.publicSurName,
  ...
  .addURL(
    ...
    `https://panel.hibritcard.com/id/${parentUrl}`
   ...
   if(getbase64Url!==""){
    ...
    myVCard.addPhoto(getbase64Url, 'JPEG')
  ...
  allPanelSort.map((v,i)=>{
    ...
    ///mYvACRD
     .addAddress(
     v.streetAdress && v.streetAdress, v.profileCountry && v.profileCountry==="Turkey" ? "Türkiye" : v.profileCountry,
    "",
    "",
    "",
    "",
...
v.panelEmailPostas.map((w,a)=>{
  ...
  const downloadTxtFile = () => {
    ...
    element.download = selectedProfileData ? selectedProfileData.publicName : "Contact";
  ...
  const downloadTxtFile2 = (v) => {
    ...
    //.addPhoto(base64, 'JPEG')
      ...
      .addAddress(
        ...
        "",
        "",
        v.profileCountry==="Turkey" ? "Türkiye" : v.profileCountry,
        "WORK"
      )
    ...
    if (allPanelSort) {
      ...
      setDropdownList(() => {
        ...
        for (let i = 0; i < allPanelSort.length + 2; i++) {
          ...
          if ( allPanelSort[i] !== undefined &&  allPanelSort[i].type === "documentForm") {
            setPostMessages((e) => [
              ...e,
              {
  ...
  function shareAllData() {
    try {
      navigator.share({
        ...
        url: `https://panel.hibritcard.com/id/${parentUrl}`,
  ...
  const backgroundColor= selectedProfileData && selectedProfileData.profileTheme === "light" ? "#FFF" : "#333";

  const saveButtonBackGround= selectedProfileData && selectedProfileData.profileTheme === "light" ? "black"  : "#8b8dff" ;
  const saveColor = selectedProfileData && selectedProfileData.profileTheme === "light" ? "#FFFF" : "#FFF"
  ...
  //qrcode generate
  // const [url, setUrl]=useState(locationKopyQr);
        ...
        >
           <a
            href={v.socialtype==="whatsapp" ? "https://wa.me/" +
             ...
             "https://www.linkedin.com/in/"+ v.socialUrlLink : "https://"+ v.socialtype +
             ".com/" + v.socialUrlLink}
            target="_blank"
          >
...
//all profile popup
const [allprofilePopup, setallprofilePopup]= useState(false);
  ...
  return (
    ...
    {/* profile Pup form here */}

    {allprofilePopup ? (

        <div className="popup-global-top-profile" >
          <div
           
           onClick={(e)=>{e.preventDefault();setallprofilePopup(false);}}
            className="popup-top"></div>
            
          <div className="popup">

            <div className="close-button" onClick={(e)=>{e.preventDefault();setallprofilePopup(!allprofilePopup);}}>
              <i className="fa-solid fa-xmark"></i>
            </div>

            <div className="header-text"> Profil Seç </div>
            <div className="select-profile-items select-profile-items-noedit-profile" style={{
              overflow:"auto"
            }}>
      ...
      <div className="profile-area">
        ...
        <div className="infos">
          ...
          <div className="profile-info">
              {selectedProfileData && selectedProfileData.profileCompany}
            </div>
...
{/* <img src="https://www.google.de/images/srpr/logo11w.png" alt="" id="imageid"  crossOrigin="anonymous"  /> */}
...
v.type === "documentForm" &&  v.panelTitle ==="" ? "İletişim Formu" : v.type === "faturaData" && v.panelTitle ==="" ? "Fatura Bilgisi" : v.panelTitle
                ...
                {dropdownList[i + 2] && dropdownList[i + 2].open == false && (
                  <div
                    className="panelName"
                    style={{
                      width: "100%",
    ...
    fontStyle: "italic"
                      ...
                      >
                        {v.type == "conatctAddForm" && "İletişim Bilgileri"}
                  ...
                  {v.type == "conatctAddForm" && (
                    <>
                      ...
                      <div className="content-in">
                        ...
                        {selectedProfileData && v.panelPhoneNumbers.length > 0 &&
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M4.96833 5.21549C7.38653 4.4089 9.83018 5.92366 10.5089 8.37611C10.9715 10.0472 10.5334 11.7996 9.46531 12.9995C9.68407 13.2828 9.92311 13.5552 10.1826 13.8149C10.4408 14.0733 10.7116 14.3115 10.9932 14.5295C12.1926 13.4529 13.9502 13.01 15.6262 13.4745C18.0782 14.1542 19.5901 16.5997 18.7848 19.0178C18.2564 20.6044 17.2711 21.5683 15.9571 21.8856C14.7361 22.1805 13.4196 21.867 12.2585 21.3844C9.91992 20.4122 7.61074 18.4974 6.55613 17.442C5.47664 16.3617 3.57003 14.0491 2.60671 11.715C2.12834 10.5559 1.82033 9.24429 2.11584 8.02889C2.43378 6.7213 3.39283 5.74096 4.96833 5.21549ZM8.58141 8.90958C8.16872 7.4185 6.79749 6.7137 5.60116 7.11273C4.54956 7.46347 4.18482 7.98485 4.05922 8.50141C3.91121 9.11016 4.03992 9.94515 4.45545 10.952C5.27992 12.9497 6.9898 15.0465 7.97088 16.0283C8.92821 16.9863 11.0228 18.7048 13.0262 19.5376C14.0361 19.9574 14.8752 20.0894 15.4876 19.9415C16.007 19.8161 16.5331 19.4492 16.8872 18.3858C17.2866 17.1867 16.5807 15.8145 15.092 15.4018C13.9841 15.0948 12.8451 15.4506 12.1672 16.1766C11.7294 16.6454 10.895 16.9126 10.1851 16.4171C9.68553 16.0684 9.21113 15.6722 8.76787 15.2286C8.3239 14.7843 7.92751 14.3087 7.57877 13.8081C7.08635 13.1012 7.3491 12.27 7.81452 11.8312C8.53515 11.1518 8.88742 10.0153 8.58141 8.90958Z" fill="#808080"/>
      ...
      <div className="profile-page-button-global-public-panele" >

        <a
          className="profile-page-button"
          href="https://panel.hibritcard.com/login"
          style={{
            justifyContent: "center",
          }}
          target="_blank"
